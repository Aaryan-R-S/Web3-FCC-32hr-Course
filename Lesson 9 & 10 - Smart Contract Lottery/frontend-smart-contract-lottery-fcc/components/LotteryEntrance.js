...
export default function LotteryEntrance() {
    ...
    const {
        ...
        abi: abi,
        contractAddress: winETHAddress,
        functionName: "enterWinETH",
    ...
    const { runContractFunction: getEntranceFee } = useWeb3Contract({
        abi: abi,
        contractAddress: winETHAddress, // specify the networkId
    ...
    async function updateUIValues() {
        ...
        // const options = { abi, contractAddress: winETHAddress }
    ...
    // const filter = {
    //     address: winETHAddress,
    //     topics: [
    //         // the name of the event, parnetheses containing the data type of each event, no spaces
    //         utils.id("WinETHEnter(address)"),
    //     ],
    // }
